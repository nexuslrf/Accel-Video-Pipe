...
class AVP_Automation:
    ...
    def visualize(self, out_path='_output'):
    ...
    def code_gen(self, cpp_file_name="", out_path="_output", additional_includes=[]):
        # @TODO 0507
        if cpp_file_name == "":
        ...
        cpp_file = open(os.path.join(out_path, cpp_file_name), "w")
