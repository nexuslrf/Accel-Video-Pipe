...
void streamSelection(avp::DataList& in_data_list, avp::DataList& out_data_list);
...
int main()
{
    ...
    // Case1 Lambda Function
    avp::TemplateProcessor multiplexer(2,2, [&](avp::DataList& in_data_list, avp::DataList& out_data_list){
        std::cout<<"Wtf?\n";
        std::cout<<multiplexer.checkEmpty()<<"\n";
        std::cout<<multiplexer.inStreams[0]->front().tensor().sizes()<<"\n";
    ...
    // avp::TemplateProcessor multiplexer(2,2, streamSelection);
